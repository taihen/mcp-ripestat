...
var ConsolidatedToolDescriptions = map[string]string{
	...
	"validateSecurity":     "Security and compliance validation including RPKI validation, abuse contact discovery, and BGP hijacking risk signals.",
	...
	"searchByLocation":     "Geographic analysis and ASN discovery by country.",
}
	...
	"analyzeRouting": {
		...
		"properties": map[string]interface{}{
			...
			"timeframe": map[string]interface{}{
				"type":        "string",
				"enum":        []string{"current"},
				"description": "BGP updates window; current is a bounded one-hour lookback",
				"default":     "current",
			},
		},
		"required":             []string{"resource"},
	...
	"validateSecurity": {
		...
		"properties": map[string]interface{}{
			...
			"checks": map[string]interface{}{
				...
				"description": "Security checks to perform. Defaults to RPKI and abuse contacts for IP resources, or abuse contacts and BGP hijacking risk signals for ASNs. Current RPKI validation is not available for an ASN alone.",
			},
			"asn": map[string]interface{}{
				"type":        "string",
				"description": "Origin ASN for RPKI validation of an IP address or prefix; required when the prefix has multiple origins",
			},
		},
		"required":             []string{"resource"},
		"additionalProperties": false,
	...
	"exploreRelationships": {
		...
		"properties": map[string]interface{}{
			...
			"relationships": map[string]interface{}{
				...
				"description": "Types of relationships to explore. Defaults to neighbors for ASNs and related networks for prefixes.",
			},
			"scope": map[string]interface{}{
				"type":        "string",
				"enum":        []string{"direct"},
				"description": "Scope of relationship exploration; extended traversal is not implemented",
				"default":     "direct",
			},
		},
		"required":             []string{"resource"},
	...
	"searchByLocation": {
		...
		"properties": map[string]interface{}{
			...
			"type": map[string]interface{}{
				"type":        "string",
				"enum":        []string{"asns"},
				"description": "Type of location-based data to retrieve; currently only ASN data is implemented",
				"default":     "asns",
			},
		},
